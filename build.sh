...
./configure clean
make clean
./configure --target-os=mingw64 --cross-prefix=x86_64-w64-mingw32 --prefix=/usr/x86_64-w64-mingw32 --static-mp4box --use-zlib=no --extra-cflags="-I/usr/x86_64-w64-mingw32/include" --extra-ldflags="-L/usr/x86_64-w64-mingw32/lib"
make -j4
